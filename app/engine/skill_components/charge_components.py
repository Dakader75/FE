...
'''class CombatChargeFill(SkillComponent):
    nid = 'combat_charge_fill'
    desc = "Fills charge for skill"
    tag = "charge"
    ...
    def end_combat(self, unit):
        action.do(action.SetObjData(self.skill, 'charge', self.skill.data['total_charge']))
'''
